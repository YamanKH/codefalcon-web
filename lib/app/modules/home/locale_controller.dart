...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'ar_SA': {
          ...
          // Calculator
          'calculator_title': 'حاسبة المشاريع',
          'select_services': 'اختر الخدمات:',
          'total': 'الإجمالي:',
          'use_calculator': 'استخدم حاسبة الخدمات',
          'calculate_prices': 'احسب أسعار خدماتنا',
          'step_1_title': 'اختر نوع المشروع',
          'step_2_title': 'اختر التقنيات',
          'step_3_title': 'اختر الباقة',
          'step_4_title': 'ملخص المشروع',
          'next': 'التالي',
          'previous': 'السابق',
          'finish': 'احصل على عرض سعر',
          'project_type': 'نوع المشروع',
          'technologies': 'التقنيات',
          'package': 'الباقة',
          'summary': 'الملخص',
          'book_consulting': 'احجز استشارة',
          'contact_whatsapp': 'تواصل واتساب',
          'premade_projects': 'مشاريع جاهزة',
          'choose_project_type': 'اختر نوع المشروع',
          'select_technologies': 'اختر التقنيات المفضلة',
          'choose_package': 'اختر الباقة',
          'project_summary_title': 'ملخص المشروع',
          'frontend_framework': 'إطار العمل الأمامي:',
          'backend_technology': 'تقنية الخلفية:',
        ...
        'en_US': {
          ...
          // Calculator
          'calculator_title': 'Project Calculator',
          'select_services': 'Select Services:',
          'total': 'Total:',
          'use_calculator': 'Use Our Calculator',
          'calculate_prices': 'Calculate Prices for Our Services',
          'step_1_title': 'Choose Project Type',
          'step_2_title': 'Select Technologies',
          'step_3_title': 'Choose Package',
          'step_4_title': 'Project Summary',
          'next': 'Next',
          'previous': 'Previous',
          'finish': 'Get Quote',
          ...
          'premade_projects': 'Pre-made Projects',
          'choose_project_type': 'Choose Your Project Type',
          'select_technologies': 'Select Your Preferred Technologies',
          'choose_package': 'Choose Your Package',
          'project_summary_title': 'Project Summary',
          'frontend_framework': 'Frontend Framework:',
          'backend_technology': 'Backend Technology:',
